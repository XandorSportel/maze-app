        ...
        <div class="builder-layout">
            <aside class="palette-panel">
                ...
                <div class="palette-groups">
                    ...
                    <fieldset><legend>Objecten</legend><div class="object-buttons"><button type="button" data-tile="O0">◆ Spijkers</button><button type="button" data-tile="O1">♣ Heg</button><button type="button" data-tile="O2">● Muur (O2)</button><button type="button" data-tile="O3">▰ Hout</button><button type="button" data-tile="R1">↻ Draai</button><button type="button" data-tile="E1">✦ Bonus</button><button type="button" data-tile="B0">● Bom</button></div></fieldset>
