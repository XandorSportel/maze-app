...
<section class="page-hero compact">
    <div><span class="eyebrow">Zandbakomgeving</span><h1>Openstaande<br><em>opdrachten.</em></h1></div>
    ...
    <div class="assignment-list">
        @forelse ($assignments as $assignment)
            <article class="assignment-row">
                ...
                <div class="assignment-name"><span>{{ $assignment->is_custom ? 'Eigen glade' : 'Zandbak' }}</span><h3>{{ $assignment->name }}</h3></div>
